var meals = [
  {
    ...
    imageAlt: "photo of meal of Margherita Pizza",
    rating: 4.9,
    reviews: 512,
    prepTime: 90,
    cookTime: 12,
  ...
  },
  {
    ...
    imageAlt: "photo of  meal of Chicken Stir-Fry",
    rating: 4.5,
    reviews: 324,
    prepTime: 15,
    cookTime: 15,
  ...
  },
  {
    ...
    image: "../images/meals/meal-3.jpg",
    imageAlt: "photo of  meal of Shrimp Scampi",
    rating: 4.8,
    reviews: 356,
    prepTime: 10,
    cookTime: 15,
  ...
  },
  {
    ...
    imageAlt: "photo of  meal of BBQ Pulled Pork",
    rating: 4.7,
    reviews: 412,
    prepTime: 15,
    cookTime: 240,
  ...
  },
  {
    ...
    image: "../images/meals/meal-5.jpg",
    imageAlt: "photo of  meal of Caesar Salad",
    rating: 4.4,
    reviews: 198,
    prepTime: 15,
    cookTime: 0,
...

  {
    ...
    image: "../images/meals/meal-6.jpg",
    imageAlt: "photo of  meal of Beef Tacos",
    rating: 4.6,
    reviews: 278,
    prepTime: 15,
    cookTime: 20,
  ...
  },
  {
    ...
    image: "../images/meals/meal-7.jpg",
    imageAlt: "photo of  meal of Creamy Spaghetti Carbonara",
    rating: 4.8,
    reviews: 234,
    prepTime: 15,
    cookTime: 20,
  ...
  },
  {
    ...
    image: "../images/meals/meal-8.jpg",
    imageAlt: "photo of  meal of Vegetable Curry",
    rating: 4.6,
    reviews: 289,
    prepTime: 20,
    cookTime: 30,
  ...
  },
  {
    ...
    image: "../images/meals/meal-9.jpg",
    imageAlt: "photo of  meal of Lasagna Bolognese",
    rating: 4.9,
    reviews: 478,
    prepTime: 30,
    cookTime: 90,
  ...
  },
  {
    ...
    image: "../images/meals/meal-10.jpg",
    imageAlt: "photo of  meal of Pad Thai",
    rating: 4.8,
    reviews: 445,
    prepTime: 20,
    cookTime: 15,
  ...
  },
  {
    ...
    image: "../images/meals/meal-11.jpg",
    imageAlt: "photo of  meal of Chicken Tikka Masala",
    rating: 4.7,
    reviews: 389,
    prepTime: 20,
    cookTime: 30,
  ...
  },
  {
    ...
    image: "../images/meals/meal-12.jpg",
    imageAlt: "photo of  meal of Classic Beef Burger",
    rating: 4.6,
    reviews: 421,
    prepTime: 15,
    cookTime: 20,
  ...
  },
  {
    ...
    image: "../images/meals/meal-13.jpg",
    imageAlt: "photo of  meal of Mediterranean Quinoa Bowl",
    rating: 4.5,
    reviews: 156,
    prepTime: 20,
    cookTime: 35,
  ...
  },
  {
    ...
    image: "../images/meals/meal-14.jpg",
    imageAlt: "photo of  meal of Honey Garlic Salmon",
    rating: 4.9,
    reviews: 187,
    prepTime: 10,
    cookTime: 15,
  ...
  },
  {
    ...
    image: "../images/meals/meal-15.jpg",
    imageAlt: "photo of  meal of Caprese Sandwich",
    rating: 4.5,
    reviews: 189,
    prepTime: 10,
    cookTime: 5,
  ...
  },
  {
    ...
    image: "../images/meals/meal-16.jpg",
    imageAlt: "photo of  meal of Thai Green Curry",
    rating: 4.7,
    reviews: 312,
    prepTime: 15,
    cookTime: 25,
  ...
  },
  {
    ...
    image: "../images/meals/meal-17.jpg",
    imageAlt: "photo of  meal of Greek Moussaka",
    rating: 4.8,
    reviews: 234,
    prepTime: 30,
    cookTime: 60,
  ...
  },
  {
    ...
    image: "../images/meals/meal-18.jpg",
    imageAlt: "photo of  meal of Teriyaki Chicken Bowl",
    rating: 4.7,
    reviews: 367,
    prepTime: 15,
    cookTime: 20,
  ...
  },
  {
    ...
    image: "../images/meals/meal-19.jpg",
    imageAlt: "photo of  meal of French Onion Soup",
    rating: 4.7,
    reviews: 267,
    prepTime: 15,
    cookTime: 60,
...
function getNewMeal() {
    ...
    if (meals.length === 1) {
      curruntIndex = 0;
      meal = meals[curruntIndex];
      displayMeal();
      return;
    }
      do {
        curruntIndex = Math.floor(Math.random() * meals.length);
      } while (prevIndex === curruntIndex); 
    prevIndex = curruntIndex; 
    meal = meals[curruntIndex];
    displayMeal();
}
getNewMeal();
...
function displayMeal() {
    ...
    document.getElementById("meal-category").innerText = meal.category;
    document.getElementById("meal-difficulty").innerText = meal.difficulty;
    document.getElementById("meal-description").innerText = meal.description;
    document.getElementById("meal-photo").src = meal.image;
    document.getElementById("meal-photo").alt = meal.imageAlt;
    document.getElementById("rating-average").innerText = meal.rating;
    document.getElementById("rating-total-review").innerText =
        `(${meal.reviews} reviews)`;
    document.getElementById("prep-time").innerText = `${meal.prepTime} min`;
    document.getElementById("cook-time-display").innerText =
      `${meal.cookTime} min`;
    document.getElementById("servings-display").innerText =
        `${meal.servings} people`;
    // Nutrition
    document.getElementById("calories").innerText = meal.nutrition.calories;
    document.getElementById("protein").innerText = meal.nutrition.protein;
    document.getElementById("carbohydrates").innerText =
        meal.nutrition.carbohydrates;
    document.getElementById("fat").innerText = meal.nutrition.fat;
    document.getElementById("fiber").innerText = meal.nutrition.fiber;
    document.getElementById("sodium").innerText = meal.nutrition.sodium;
    // Ingredients
    var ingredientsList = "";
    for (var i = 0; i < meal.ingredients.length; i++) {
        ingredientsList += `<li class="d-flex column-gap-2 align-items-center">
                                <div class=" rounded-circle d-flex align-items-center justify-content-center text-white fs-75 fw-bold  flex-shrink-0">${i + 1}</div>
    ...
    for (var i = 0; i < meal.instructions.length; i++) {
        instructionsList += ` <div class="d-flex gap-3 align-items-start">
                                <div  class="rounded-4 d-flex align-items-center justify-content-center text-white fs-1-25 fw-bold flex-shrink-0">
                                    ${i + 1}
                                </div>
                                <div class=" pt-2">
    ...
    for (var i = 0; i < meal.tips.length; i++) {
        tipsList += ` <div class="d-flex  p-3 rounded-3 w-100 column-gap-3 align-items-center">
                        <i class=" fa-solid fa-circle-check fs-1-25"></i>
                        <p>${meal.tips[i]}</p>
                    </div>`;
    }
    document.getElementById("tips-list").innerHTML = tipsList;
    //   Warning Message
